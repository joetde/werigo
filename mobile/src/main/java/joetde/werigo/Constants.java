...
public class Constants {
    public static final double METERS_IN_A_DEGREE = 111194.92664455873;
    ...
    public static final double SIMILARITY_IN_SPACE_DEGREE = SIMILARITY_IN_SPACE / METERS_IN_A_DEGREE;
